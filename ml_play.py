        ...
        if player == '1P':
            if scene_info["platform_1P"][0]+20  > (pred-10) and scene_info["platform_1P"][0]+20 < (pred+10):
                ...
                if scene_info["ball"][0] > scene_info["platform_1P"][0]+20:
                    return 1
                    #elif scene_info["ball"][0] < scene_info["platform_1P"][0]+20 and scene_info["platform_1P"][0]+15> (pred-10) and scene_info["platform_1P"][0]+15 < (pred+10):
                     #   return 2
                else :
                    return 0 # NONE
            ...
            if scene_info["platform_2P"][0]+20  > (pred-15)and scene_info["platform_2P"][0]+20 < (pred+10):
                if scene_info["platform_2P"][1]+30 > scene_info["ball"][1]+scene_info["ball_speed"][1] : #slice
                    return 0
